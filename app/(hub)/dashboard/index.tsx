                ...
                {isSessionLoading || isHydrating ? (
                    ...
                    <View style={{ gap: 12 }}>
                        ...
                        <StatsCard
                            ...
                            onPressSuperLiked={() => router.push({ pathname: '/(assignment)/recommendations', params: { filter: 'super_liked' } } as any)}
                        />
                        ...
                        <View style={{ flex: 1 }}>
                            <DiscoveryCard
                                ...
                                onStartExploring={() => router.push('/(assignment)/assignments' as any)}
                                onJobPreferencesPress={() => router.push('/(profile)' as any)}
                            />
                        </View>
