...
import { ChevronRight, Plus, MapPin, Calendar, Bed, Trash2, X } from 'lucide-react-native';
    ...
    if (durationDays > 1 && !hasStops) {
      Alert.alert(
        ...
        [
          ...
          { text: 'Continue Anyway', style: 'cancel', onPress: () => router.push('./review') }
        ]
      );
    } else {
      router.push('./review');
