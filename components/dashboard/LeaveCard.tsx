...
export function LeaveCard({ balance, pendingRequest, onPress }: LeaveCardProps) {
    return (
        <TouchableOpacity onPress={onPress} activeOpacity={0.9} className="bg-card rounded-xl p-3 border border-subtle flex-row items-center justify-between relative overflow-hidden min-h-[60px]" style={{ shadowColor: '#000', shadowOpacity: 0.06, shadowOffset: { width: 0, height: 4 }, shadowRadius: 10, elevation: 4 }}>
            {/* Decorative Corner */}
            ...
            <View className="flex flex-col">
                ...
                <View className="flex-row items-baseline gap-1">
                    <Text className="text-xl font-bold text-primary leading-none mt-0.5">{balance}</Text>
