...
import { Calendar, CheckCircle2, DollarSign, Scale } from 'lucide-react-native';
import React from 'react';
import { Pressable, Text, View, useColorScheme } from 'react-native';

interface HHGWizardStatusBarProps {
    currentStep: number;
...
const STEPS = [
    { id: 0, icon: Scale, label: 'Weight' },
    { id: 1, icon: DollarSign, label: 'Cost' },
    { id: 2, icon: Calendar, label: 'Dates' },
    { id: 3, icon: CheckCircle2, label: 'Review' },
];

export function HHGWizardStatusBar({ currentStep, onStepPress, errorSteps = [] }: HHGWizardStatusBarProps) {
