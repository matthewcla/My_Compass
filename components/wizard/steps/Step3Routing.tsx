        ...
        <WizardCard title="Command Coverage">
            <View className="gap-6">
                ...
                <View className="gap-3">
                    ...
                    <View className="bg-white dark:bg-slate-900 rounded-2xl p-4 border border-slate-200 dark:border-slate-700 gap-4">
                ...
                <View className="gap-3">
                    ...
                    <View className="bg-white dark:bg-slate-900 rounded-2xl p-2 border border-slate-200 dark:border-slate-700 flex-row">
